          ...
          <?php foreach ($data['products'] as $published) : ?>
            <tr id="<?php echo $published['post_ID'] ?>">
              ...
              <td class="column-actions">
                <a href="#" type="button" class="button button-primary button-small action-button fix-price" data-action="fix-price" data-success-label="<?php echo __('Fixed', 'astra-child') ?>" data-post-id="<?php echo $published['post_ID'] ?>" data-kleinanzeigen-id="<?php echo $published['sku'] ?>" data-price="<?php echo $published['price'] ?>" data-ka-price="<?php echo $published['ka_price'] ?>" data-screen="modal"><?php echo __('Fix price', 'astra-child') ?></a>
              </td>
            </tr>
          <?php endforeach ?>
        <?php endif ?>
...
<div class="button-controls left">
  <a href="#" type="button" class="button action-button button-primary fix-price-all <?php echo empty($data['products']) ? 'disabled' : '' ?>" data-action="fix-price-all"><?php echo __('Fix all prices', 'astra-child') ?></a>
</div>
