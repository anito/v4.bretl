...
function _ajax_feature_post()
{
  wbp_ajax_feature_post();
}
...
function wbp_admin_init()
{
  ...
  add_action('wp_ajax__ajax_feature_post', '_ajax_feature_post');
  ...
  add_action('wp_ajax_nopriv__ajax_feature_post', '_ajax_feature_post');
