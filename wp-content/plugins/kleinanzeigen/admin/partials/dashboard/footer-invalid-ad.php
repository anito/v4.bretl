<div style="font-size: 0.8em;">
  <div>
    <h3 style="margin: 5px 0;"><?php echo __('Term definitions for available actions:', 'kleinanzeigen') ?></h3>
  </div>
  <div style="display: flex;">
    <span style="flex: 0 0 130px; margin-right: 10px;"><b><?php echo __('Keep', 'kleinanzeigen') ?>:</b></span>
