      ...
      self::$tax_definitions = array(
        'label' => array(
          'labels' => array(
            ...
            'all_items' => __('Search product labels', 'kleinanzeigen'),
            'edit_item' => __('Edit product label', 'kleinanzeigen'),
            'update_item' => __('Update product label', 'kleinanzeigen'),
            'new_item_name' => __('Name of product label', 'kleinanzeigen'),
            'not_found' => __('Product label not found', 'kleinanzeigen'),
            'item_link' => __('Product label link', 'kleinanzeigen'),
            'item_link_description' => __('Link to product label', 'kleinanzeigen'),
          ),
          'metaboxes' => array(
            'types' => array(
              'colorpicker' => array(
        ...
        'brand' => array(
          'labels' => array(
            ...
            'all_items' => __('Search product brands', 'kleinanzeigen'),
            'edit_item' => __('Edit product brand', 'kleinanzeigen'),
            'update_item' => __('Update product brand', 'kleinanzeigen'),
            'new_item_name' => __('Name of product brand', 'kleinanzeigen'),
            'not_found' => __('Product brand not found', 'kleinanzeigen'),
            'item_link' => __('Product brand link', 'kleinanzeigen'),
            'item_link_description' => __('Link to product brand', 'kleinanzeigen'),
          ),
          'metaboxes' => array(
            'types' => array(
              'image' => array(
