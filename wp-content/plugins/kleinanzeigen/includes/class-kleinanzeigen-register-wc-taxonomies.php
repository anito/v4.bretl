        ...
        'label' => array(
          'labels' => array(
            ...
            'search_items'               => __( 'Search product labels', 'kleinanzeigen' ),
						...
						'view_item'                  => __( 'View product label', 'kleinanzeigen' ),
						'edit_item'                  => __( 'Edit product label', 'kleinanzeigen' ),
						'update_item'                => __( 'Update product label', 'kleinanzeigen' ),
						'add_new_item'               => __( 'Add new product label', 'kleinanzeigen' ),
						'new_item_name'              => __( 'New product label name', 'kleinanzeigen' ),
        ...
        'brand' => array(
          'labels' => array(
            ...
            'search_items'               => __( 'Search product brands', 'kleinanzeigen' ),
						...
						'view_item'                  => __( 'View product brand', 'kleinanzeigen' ),
