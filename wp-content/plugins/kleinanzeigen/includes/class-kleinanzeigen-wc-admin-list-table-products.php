...
?>
          <div class="sync-column-content">
            <div id="import-kleinanzeigen-data-wbp-action-<?php echo $post_ID ?>" style="flex: 1;">
              ...
              <a id="import-kleinanzeigen-data-<?php echo $post_ID ?>" disabled name="import-kleinanzeigen-data" data-kleinanzeigen-id="<?php echo $sku ?>" data-post-id="<?php echo $post_ID ?>" class="import-kleinanzeigen-data button button-primary button-small"><?php echo __('Import Data', 'kleinanzeigen') ?></a>
            </div>
            <div id="import-kleinanzeigen-images-wbp-action-<?php echo $post_ID ?>" style="flex: 1;">
              ...
              <span class="kleinanzeigen-images-wrapper" style="display: flex;">
                <a id="import-kleinanzeigen-images-<?php echo $post_ID ?>" disabled name="import-kleinanzeigen-images" data-kleinanzeigen-id="<?php echo $sku ?>" data-post-id="<?php echo $post_ID ?>" class="import-kleinanzeigen-images button button-primary button-small"><?php echo __('Import Images', 'kleinanzeigen') ?></a>
