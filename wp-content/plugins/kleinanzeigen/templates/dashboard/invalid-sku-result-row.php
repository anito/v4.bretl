<div class="actions" data-id="<?php echo $post_ID ?>">
  ...
  <a href="#" type="button" class="button button-primary button-small action-button delete <?php echo $disabled['delete'] ? 'disabled' : '' ?>" data-task-type="<?php echo $task_type ?>" data-action="delete" data-post-id="<?php echo $post_ID ?>" data-kleinanzeigen-id="<?php echo $sku ?>" data-args="<?php echo base64_encode(json_encode(array('post_status' => 'trash'))) ?>" data-screen="modal"><?php echo $label['delete'] ?></a>
</div>
